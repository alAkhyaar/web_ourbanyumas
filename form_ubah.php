...
<head>
  ...
  <link rel="shortcut icon" href="images/logokublack.png">
  <style>
    .intro {
        ...
        <tr>
          ...
          <td>
            ...
            if ($data['jenis_wisata'] == "Wisata Alam") {
              echo "<input type='radio' name='jenis_wisata' value='Kolam Renang' checked='checked'> Kolam Renang";
              echo "<input type='radio' name='jenis_wisata' value='Wisata Alam'> Wisata Alam";
              echo "<input type='radio' name='jenis_wisata' value='Wisata Modern'> Wisata Modern";
              ...
              echo "<input type='radio' name='jenis_wisata' value='Wisata Modern'> Wisata Modern";
              echo "<input type='radio' name='jenis_wisata' value='Kolam Renang'> Kolam Renang";
            } else {
              echo "<input type='radio' name='jenis_wisata' value='Wisata Modern' checked='checked'> Wisata Modern";
              echo "<input type='radio' name='jenis_wisata' value='Kolam Renang'> Kolam Renang";
              echo "<input type='radio' name='jenis_wisata' value='Wisata Alam'> Wisata Alam";
            }
            ?>
