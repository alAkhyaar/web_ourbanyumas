    ...
    <form method="post" action="proses_ubah_artikel.php?id=<?php echo $id; ?>" enctype="multipart/form-data">
      <table cellpadding="8" align="center">
        <tr>
          <td>Judul</td>
          <td>
            <p><textarea name="judul"><?php echo $data['judul']; ?></textarea></p>
          </td>
        </tr>
        <tr>
          <td>Keterangan</td>
          <td>
            <p><textarea name="keterangan"><?php echo $data['keterangan']; ?></textarea></p>
          </td>
        </tr>
        <tr>
          <td>Alamat URL</td>
          <td>
            <p><textarea name="url"><?php echo $data['url']; ?></textarea></p>
          </td>
        </tr>
        <tr>
          <td>Foto</td>
